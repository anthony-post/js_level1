...
function clickHandler(event) {
    ...
    divProduct.textContent = ''; //Игорь, скажите, пожалуйста, какая разница между innerHTML и textContent?
...
function getProductMarkup(product) {
    ...
    for (let i = 0; i < product.length; i++) {
        ...
        let productImageUrl = product[i].imageUrl;

        divProduct.insertAdjacentHTML('beforeend', `<div class="product">
        <div>${productName}</div>
